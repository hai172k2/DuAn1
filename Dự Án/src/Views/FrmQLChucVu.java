...
public class FrmQLChucVu extends javax.swing.JFrame {
    ...
    private String getChucVuIdFromSelectedRow() {
        int selectedRowIndex = tbChucVu.getSelectedRow();
        return (String) this.tbChucVu.getValueAt(selectedRowIndex, 0);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ChucVu newChucVu = getChucVuFromInput();
        if (_iManageChucVuService.createChucVu(newChucVu) != null) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        ChucVu updatedChucVu = getChucVuFromInput();
        String updatedNSXid = getChucVuIdFromSelectedRow();
        updatedChucVu.setId(updatedNSXid);

        if (_iManageChucVuService.updateChucVu(updatedChucVu) != null) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String selectedId = getChucVuIdFromSelectedRow();
        _iManageChucVuService.delete(selectedId);
        loadDataToTable();
