...
public class FrmQLSanPham extends javax.swing.JFrame {
    ...
    private String getIdFromSelectedRow() {
        ...
        return (String) this.tbSanPham.getValueAt(selectedRowIndex, 0);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        SanPham newSanPham = getFromInput();
        if (_iManageSanPhamService.create(newSanPham) != null) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        SanPham upDated = getFromInput();
        String updatedNSXid = getIdFromSelectedRow();
        upDated.setId(updatedNSXid);

        if (_iManageSanPhamService.update(upDated) != null) {
            JOptionPane.showMessageDialog(this, "Thành công");
        } else {
            JOptionPane.showMessageDialog(this, "Thất bại");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        _iManageSanPhamService.delete(selectedId);
        loadDataToTable();
